...
/**
  ...
  */
WIDGET_POS_SIZE_T _7_help_windows=
{
...
/**
  ...
  * @retval 无
  */
void _7_init_help_win_layout1_text_ele_pos(TEXT_ELE_T *pool)
{
    ...
    //软件版本号
//    inf.pos_size.y += 40;
    memcpy(&pool[HELP_WIN_SOFT_VER].dis_info, &inf, sizeof(UI_ELE_DISPLAY_INFO_T));
    
    //硬件版本号
    inf.pos_size.y += 22;
//    inf.pos_size.x += 230;
    memcpy(&pool[HELP_WIN_HARD_VER].dis_info, &inf, sizeof(UI_ELE_DISPLAY_INFO_T));
    
    //公司名称
    inf.pos_size.y += 22;
    memcpy(&pool[HELP_WIN_LTD].dis_info, &inf, sizeof(UI_ELE_DISPLAY_INFO_T));
    
    //地址
    inf.pos_size.y += 22;
    inf.pos_size.height = 60;
    memcpy(&pool[HELP_WIN_ADDRESS].dis_info, &inf, sizeof(UI_ELE_DISPLAY_INFO_T));
    ...
    memcpy(&pool[HELP_WIN_NOTICE].dis_info, &inf, sizeof(UI_ELE_DISPLAY_INFO_T));
