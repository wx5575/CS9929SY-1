...
#define _7_SEL_CAL_MODULE_EDIT_WIDTH       140
#define _7_SEL_CAL_MODULE_WIN_X            (800 - 110 - _7_SEL_CAL_MODULE_WIN_WIDTH) / 2
#define _7_SEL_CAL_MODULE_WIN_Y            150
/* 密码界面文本对象自动布局结构 */
EDIT_ELE_AUTO_LAYOUT_T _7_sel_cal_module_edit_ele_auto_layout_inf=
{
    (_7_SEL_CAL_MODULE_WIN_WIDTH - _7_SEL_CAL_MODULE_EDIT_WIDTH) / 2/*base_x*/,50/*base_y*/,
    1/*name_w*/,_7_SEL_CAL_MODULE_EDIT_WIDTH/*edit_w*/,1/*uint_w*/,30/*height*/,
