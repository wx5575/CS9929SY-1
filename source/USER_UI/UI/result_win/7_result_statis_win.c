...
#define RES_STATIS_W   450
#define RES_STATIS_H   300
#define RES_STATIS_X   (800 - 110 - RES_STATIS_W) / 2
#define RES_STATIS_Y   80
/**
  * @brief  7寸屏窗口的位置尺寸信息
  */
...
#define RES_STATIS_ELE_T_W       300 //RES_STATIS_W - RES_STATIS_BASE_T_X * 2
...
TEXT_ELE_AUTO_LAYOUT_T _7_result_statis_win_text_ele_auto_layout_inf=
{
   RES_STATIS_BASE_T_X/*base_x*/,RES_STATIS_BASE_T_Y/*base_y*/,
    ...
    6/*rows*/,1/*column*/,30/*row_spacing*/,0/*column_spacing*/,
