...
static void module_win_f1_cb(KEY_MESSAGE *key_msg);
static void module_win_f2_cb(KEY_MESSAGE *key_msg);
static void module_win_f3_cb(KEY_MESSAGE *key_msg);
static void module_win_f4_cb(KEY_MESSAGE *key_msg);
static void module_win_f5_cb(KEY_MESSAGE *key_msg);
static void module_win_f6_cb(KEY_MESSAGE *key_msg);
...
/** 主界面使用的菜单键信息的配置 */
static MENU_KEY_INFO_T 	module_win_menu_key_inf[] = 
{
    {"", F_KEY_NULL		, KEY_F1 & _KEY_UP, module_win_f1_cb },//f1
    {"", F_KEY_NULL		, KEY_F2 & _KEY_UP, module_win_f2_cb },//f2
    {"", F_KEY_NULL		, KEY_F3 & _KEY_UP, module_win_f3_cb },//f3
    {"", F_KEY_NULL		, KEY_F4 & _KEY_UP, module_win_f4_cb },//f4
    {"", F_KEY_ENTER    , KEY_F5 & _KEY_UP, module_win_f5_cb },//f5
    {"", F_KEY_BACK		, KEY_F6 & _KEY_UP, module_win_f6_cb },//f6
};
/**
  * @brief  主界面的文本对象池
  */
...
//{
//	{{"本控","LOCAL"}, module_win_COM_ST },
//	{{"2017-04-07 08:59:00","2017-04-07 08:59:00"}, module_win_SYS_TIME },
//};
/**
  * @brief  启动窗口结构体初始化
  */
...
/**
  ...
  * @retval 无
  */
static void init_module_win_text_ele_pos_inf(void)
{
    switch(SCREEM_SIZE)
    {
    case SCREEN_4_3INCH:
...
/**
  ...
  * @retval 无
  */
static void draw_module_win_status_bar(void)
{
...
static void update_module_win_menu_key_inf(WM_HMEM hWin)
{
	init_menu_key_info(module_win_menu_key_inf, ARRAY_SIZE(module_win_menu_key_inf), hWin);
}
