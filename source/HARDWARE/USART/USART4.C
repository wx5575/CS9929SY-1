...
void uart4_config(uint32_t baud_rate)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_UART4, ENABLE); //开启UART4时钟
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE);  //开启GPIOC时钟
    GPIO_PinAFConfig(GPIOC, GPIO_PinSource6, GPIO_AF_UART4);//这相当于M3的开启复用时钟？只配置复用的引脚，
    ...
    USART_ITConfig(UART4, USART_IT_RXNE, ENABLE); //使能 UART4中断
...
/**
  ...
  * @retval 发送状态
  */
uint8_t uart4_get_send_status(void)
{
...
/**
  ...
  * @retval 接收数据缓冲区地址
  */
uint8_t* uart4_get_receive_data(void)
{
...
/**
  ...
  * @retval 无
  */
uint32_t uart4_get_receive_data_count(void)
{
...
/**
  ...
  * @retval 无
  */
void uart4_clear_receive_data_count(void)
{
    receive_count = 0;
}
/**
  ...
  * @retval 发送数据缓冲区地址
  */
uint8_t * uart4_get_send_buf(void)
{
...
/**
  ...
  * @retval 超时计数器值
  */
uint32_t uart4_get_timeout(void)
{
...
/**
  ...
  * @retval 无
  */
uint32_t uart4_sub_timeout(void)
{
    usart_timeout--;
...
/**
  ...
  * @retval 接收完成标志
  */
uint8_t get_uart4_receive_over_flag(void)
{
...
/**
  ...
  * @retval 无
  */
void clear_uart4_receive_over_flag(void)
{
...
/**
  ...
  * @retval 无
  */
void uart4_clear_receive_count(void)
{
    receive_count = 0;
}
/**
